...
public class PaymentTable {
    ...
    public static final String CREATE_PAYMENT_TABLE="CREATE TABLE " + PAYMENT_TABLE + "("+PAYMENT_ID+" INTEGER PRIMARY KEY AUTOINCREMENT,"+PAYMENT_AMOUNT+" INTEGER,"+ADVANCE_AMOUNT+" INTEGER,"+REMAINING_AMOUNT+" INTEGER, "+UPLOAD_STATUS+" TEXT, "+CHULLHA_IMAGE+" TEXT, "+CUSTOMER_ID+" INTEGER)";
